...
function setuppython() {
	...
	if [ ! -d ~/.pyenv/versions/3.11.6 ]; then
		pyenv install 3.11.6
		pyenv virtualenv 3.11.6 py3116
		/home/$USERNAME/.pyenv/versions/3.11.6/envs/py3116/bin/python3.11 -m pip install --upgrade pip wheel
